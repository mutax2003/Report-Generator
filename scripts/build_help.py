...
Press <strong>F1</strong> anytime to open this help file.</p>
<table>
<tr><th>Action</th><th>How</th></tr>
<tr><td>Help contents</td><td><kbd>F1</kbd> (global) or Help → Contents</td></tr>
<tr><td>Open / focus project folder</td><td>File menu</td></tr>
...
<body>
  <div class="layout">
    ...
    <main>
      {"".join(sections)}
      <p class="footer">Created by Andrew Liu, Ecoventure Inc., Copyright 2026 · F1 opens this help from the app.</p>
    </main>
  </div>
</body>
</html>
